...
const ProductVideos = [
  [
    ...
    {
      product: 'zaxe-z3',
      slug: 'zxz3-dissemble-head-z3',
      label: 'content-zxz3:starterVideos.9.label',
      videoURL: `${CDNURL}videos/zaxe-z3/dissemble-head.mp4`,
      thumbnail: `${CDNURL}videos/zaxe-z3/thumbnails/dissemble-head.webp`,
      category: 'maintenance',
      tags: [
        '*',
        'z3',
