---
title: About xCloud
description: xCloud is Zaxe’s own 3D printing mobile application. It provides the connection between Zaxe 3D Printers and our users to ensure a better 3D printing process.
author: Zaxe
...
### <span className="list-number">1.</span> Stay Connected 
...
### <span className="list-number">2.</span> Live Remote Monitoring
...
### <span className="list-number">3.</span> Multiple Printer Control
...
### <span className="list-number">4.</span> Instant Feedback
...
### <span className="list-number">5.</span> Updates 
