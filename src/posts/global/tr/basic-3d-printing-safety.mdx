...
description: The saying "safety first" has the same weight in 3D printing as it does in any other work environment. 3D printers are not inherently dangerous devices.
author: Zaxe
