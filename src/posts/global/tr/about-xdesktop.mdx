...
description: To capture the perfect balance between simplicity and user freedom, we created an interface that gives you the basic settings while also granting you...
author: Zaxe
