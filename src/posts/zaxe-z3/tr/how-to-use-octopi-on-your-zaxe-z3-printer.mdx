---
title: Zaxe Z3 Yazıcınızda OctoPi Nasıl Kullanılır
description: To install OctoPi to your 3D printer, usually, you would need to install it on an SD card and would have to do it manually.
author: Zaxe
category: {"name":"Yazılım","slug":"software"}
tags: ["*","octopi","octo","kullanmak","kullanılır","kullanım"]
---
...
Your 3D printer will give you an IP address. Enter that IP address into your browser, fill in both the **username** and **password** sections with **zaxe** and you are good to go.
