---
title: Doing Basic Maintenance on Your Zaxe Z3 3D Printer
description: For your 3D printer to function at its full potential, basic maintenance will be necessary. While there are businesses out there that do maintenance as a service, acquiring the help of a professional won't always be the most cost and time-effective way. So, knowing how to do basic maintenance is a must-learn for all 3D printer users. 
author: Zaxe
...
<ColumnImage image={{imageURL:"posts/basic-maintenance-zaxe-z3/img/zaxe-z3-rail-oiling.webp",imageALT:"Zaxe Z3 Rail Oiling"}}>
...
<ColumnImage image={{imageURL:"posts/basic-maintenance-zaxe-z3/img/zaxe-z3-adjusting-belt-tension.webp",imageALT:"Zaxe Z3 Adjusting Belt Tension"}}>
...
We advise all our users not to bother with adjusting the belt tension unless there is a problem with it. We use countless Zaxe Z3s on our farm 24/7 and we barely need to change anything unless we are sure there is a problem with it.
</ColumnImage>

<ColumnImage image={{imageURL:"posts/basic-maintenance-zaxe-z3/img/zaxe-z3-changing-nozzle.webp",imageALT:"Zaxe Z3 Changing Nozzle"}}>
## Changing the Nozzle 

Changing the nozzle will be relatively simple. 

- First, you will have to heat the print head so the heater block expands and makes it easier for you to remove the nozzle. You can go to the Settings menu on your Zaxe Z3 and choose the Change Nozzle option for this.  
...
<ColumnImage image={{imageURL:"posts/basic-maintenance-zaxe-z3/img/zaxe-z3-changing-hepa-filter.webp",imageALT:"Zaxe Z3 Replacing HEPA Filter"}}>
## Replacing the HEPA Filter 

The HEPA filter helps reduce the plastic particles that your Zaxe Z3 releases into the environment. Like some of the other parts in your 3D printer, your filter will also have a service life. We recommend changing it every 1000 hours of printing. 
