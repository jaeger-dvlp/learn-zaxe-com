...
tags: ["x3","repair","fan","replace","replacement"]
---
...
Video Component! Turn the printer off. Grab the printer’s housing and change the printer’s position so that you can easily access the bottom plate. Unscrew the four screws that secure the bottom plate.
</ColumnVideo>
