...
description: Periodically, a new version of the Zaxe X3 firmware is released. To ensure that your Zaxe X3 has the latest features, we recommend keeping the firmware updated.
author: Zaxe
