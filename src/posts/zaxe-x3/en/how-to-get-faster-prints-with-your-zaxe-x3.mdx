---
title: How to Get Faster Prints with Your Zaxe X3
description: One of the best things about 3D printing is the quick turnaround rates you can’t achieve with any other manufacturing method. 3D printing is fast and the devices are getting faster every year but the speed of additive manufacturing can still be not enough in some cases. 
author: Zaxe
category: {"name":"Tips & Tricks","slug":"tips-tricks"}
tags: ["faster","print","speed"]
---
...
<ColumnImage image={{imageURL:"posts/how-to-get-faster-prints-with-your-zaxe-x3/img/how-to-get-faster-prints-change-print-speed.webp",imageALT:"Zaxe X3 - Change Printing Speed"}}>
## Change the Printing Speed 

The most obvious solution to this problem would be to change the printing speed on your Zaxe X3. After you start the printing process, press the Settings icon on your 3D printer’s touchscreen. You will be able to adjust the printing speed directly from this menu. Keep in mind that increasing the printing speed too much might have a negative effect on the quality and precision of your print.  
</ColumnImage>

<ColumnImage image={{imageURL:"posts/how-to-get-faster-prints-with-your-zaxe-x3/img/how-to-get-faster-prints-increase-layer-height.webp",imageALT:"Zaxe X3 - Increase the Layer Height"}}>
...
<ColumnImage image={{imageURL:"posts/how-to-get-faster-prints-with-your-zaxe-x3/img/how-to-get-faster-prints-decrease-infill-density.webp",imageALT:"Zaxe X3 - Decrease the Infill Density"}}>
...
<ColumnImage image={{imageURL:"posts/how-to-get-faster-prints-with-your-zaxe-x3/img/how-to-get-faster-prints-change-infill-pattern.webp",imageALT:"Zaxe X3 - Change the Infill Pattern"}}>
...
<ColumnImage image={{imageURL:"posts/how-to-get-faster-prints-with-your-zaxe-x3/img/how-to-get-faster-prints-adjust-support-angle.webp",imageALT:"Zaxe X3 - Adjust Support Angles"}}>
...
<ColumnImage image={{imageURL:"posts/how-to-get-faster-prints-with-your-zaxe-x3/img/how-to-get-faster-prints-change-orientation-of-model.webp",imageALT:"Zaxe X3 - Change the Orientation of the Model"}}>
