---
title: Zaxe xDesktop Hakkında
description: Our goal is not just to make great 3D printers, sell them, and be done. We want to create a complete Zaxe 3D Printing Ecosystem to make the process better and easier. To complete this ecosystem, we needed to develop our own software to allow our users to take full control over their production line.
author: Zaxe
