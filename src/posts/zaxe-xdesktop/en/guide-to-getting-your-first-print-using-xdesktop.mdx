---
title: Guide to Getting Your First Print Using xDesktop
...
## <span className="text-zaxe">1.</span> Download xDesktop
...
## <span className="text-zaxe">2.</span> Import a Model
...
## <span className="text-zaxe">3.</span> Adjust the Model Orientation
...
## <span className="text-zaxe">4.</span> Select Your Printer
...
## <span className="text-zaxe">5.</span> Pick the Filament
...
## <span className="text-zaxe">6.</span> Choose Layer Height
...
## <span className="text-zaxe">7.</span> Adjust Fill Density
...
## <span className="text-zaxe">8.</span> Slice It!
