...
description: After your Zaxe 3D printer is plugged in and the filament is installed, you need to get yourself to our website to download xDesktop from the software section.
author: Zaxe
category: {"name":"Start","slug":"start"}
tags: ["*","print","guide","first","xdesktop"]
---
